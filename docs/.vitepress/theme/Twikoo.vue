...
const envId = 'https://comments.oplog.cn'
...
<template>
  <div class="comment-container vp-raw">
    ...
    <!-- Twikoo -->
    <div id="twikoo"></div>
    <component :is="'script'" src="https://registry.npmmirror.com/twikoo/1.7.13/files/dist/twikoo.min.js" crossorigin="anonymous" ref="twikooJs"></component>
  </div>
</template>
